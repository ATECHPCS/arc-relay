...
func TestCodexTargetReadRelayServers(t *testing.T) {
	...
	config := `
[mcp_servers.sentry]
url = "http://10.10.69.50:8080/mcp/sentry"
...
[mcp_servers.pfsense]
url = "http://10.10.69.50:8080/mcp/pfsense"
http_headers = {Authorization = "Bearer key"}
`
...
func TestCodexTargetWriteNewFile(t *testing.T) {
	...
	if entry["url"] != "http://10.10.69.50:8080/mcp/sentry" {
		t.Errorf("url = %q, want http://10.10.69.50:8080/mcp/sentry", entry["url"])
	}
...
func TestCodexTargetWriteMultipleServers(t *testing.T) {
	...
	servers := []ManagedServer{
		{Name: "sentry", URL: "http://10.10.69.50:8080/mcp/sentry"},
		{Name: "pfsense", URL: "http://10.10.69.50:8080/mcp/pfsense"},
