...
func TestServerProxyURL(t *testing.T) {
	...
	want := "http://10.10.69.50:8080/mcp/sentry"
	if got != want {
...
func TestIsWranglerURL(t *testing.T) {
	...
	tests := []struct {
		...
		{"http://10.10.69.50:8080/mcp/sentry", true},
		{"http://10.10.69.50:8080/mcp/pfsense", true},
		{"http://other-host:8080/mcp/sentry", false},
		{"http://10.10.69.50:8080/api/servers", false},
...
func TestServerNameFromURL(t *testing.T) {
	...
	tests := []struct {
		...
		{"http://10.10.69.50:8080/mcp/sentry", "sentry"},
		{"http://10.10.69.50:8080/mcp/home-assistant", "home-assistant"},
		{"http://10.10.69.50:8080/mcp/sentry/extra/path", "sentry"},
		{"http://other-host/mcp/sentry", ""},
		{"http://10.10.69.50:8080/api/servers", ""},
	}
